...
#define MAX_DATA_SIZE 100000	// n [1, 100 000], segun enunciado del problema erasmus
#define MAX_DIGITS 6			// 100000 -> 6 digitos
#define TIMEOUT 3000			// timeout para que termine un proceso. [milisecs]
#define DATA_INCREMENT 253		//	incremento de la N del problema de entrada
#define INITIAL_N 1
...
//  Create windows process : https://docs.microsoft.com/en-us/windows/win32/api/processthreadsapi/nf-processthreadsapi-createprocessa?redirectedfrom=MSDN
