/////////////////////////////////////////
// cases generator and time chrono for 354 problem in aceptaelreto.com (Los ninos primero)
// Linux version
//	O (N)
...
#include "../../utils.h"
#define MIN_CASOS 1
#define MAX_CASOS 200000	// N [1, 100 000], segun enunciado del problema erasmus
...
//data sizes , (percents of max N)
	int observations[OBSERVATIONS] = { 10, MAX_CASOS/2, MAX_CASOS};
	...
	for (int i = 0; i < OBSERVATIONS; i++) {
		...
		if (pid == -1) {
			...
			const char* const argx[] = {"354.exe", nullptr};
			if (execvp("./354.exe", argx ) == -1)
				exit(EXIT_FAILURE);
		} else {
